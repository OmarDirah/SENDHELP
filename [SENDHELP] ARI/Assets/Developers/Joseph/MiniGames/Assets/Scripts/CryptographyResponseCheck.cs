...
public class CryptographyResponseCheck : MonoBehaviour
{
    ...
    void checkKeyEntry()
    {
        ...
        {
            FindObjectOfType<CryptographyGameManager>().LevelProgress();
        }
        else
        {
    ...
    public void checkEntry()
    {
        ...
        levelStage = FindObjectOfType<CryptographyGameManager>().GetLevel();
