...
public class AsteroidsPlayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        FindObjectOfType<AsteroidsGameManager>().SetScoreText();
        FindObjectOfType<AsteroidsGameManager>().SetLivesText();
    }
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.tag == "Asteroid")
        {
            ...
            FindObjectOfType<AsteroidsGameManager>().PlayerDeath(this);
        }
    }
}
