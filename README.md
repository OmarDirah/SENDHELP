# ARI 
## _An interactice, Entertaining CyberSecurity learning expereince for all_

ARI is a lightweight, educational CyberSecurity video game designed to elevate users knowlege in modern day cybersecurity practices. 
Designed by students, for students, professionals and enthusiasts

##### During a live playtest in December of 2020, an audience member commented:
- ___“We have to do a lot of cybersecurity training at work. This would be much more fun and enjoyable”___

## Objectives
- Play the game, collect objects and knowlege in best CyberSecurity practices
- Utilize knowlege obtained to complete the game, and compete with friends and peers
- Give clients a fun, and highly educational experience
---
...
##### levelInstance
```String```
- Idintify which level the player is currently on 
